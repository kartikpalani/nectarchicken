...
class BalanceSheetsControllerTest < ActionController::TestCase
  ...
  test "should create balance_sheet" do
    assert_difference('BalanceSheet.count') do
      post :create, balance_sheet: { cash: @balance_sheet.cash, inventory_total: @balance_sheet.inventory_total, payable: @balance_sheet.payable, receivable: @balance_sheet.receivable }
    end
  ...
  test "should update balance_sheet" do
    patch :update, id: @balance_sheet, balance_sheet: { cash: @balance_sheet.cash, inventory_total: @balance_sheet.inventory_total, payable: @balance_sheet.payable, receivable: @balance_sheet.receivable }
    assert_redirected_to balance_sheet_path(assigns(:balance_sheet))
  end
